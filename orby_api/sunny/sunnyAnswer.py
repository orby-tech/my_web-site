...
def prelued():
	...
	data = pickle.load(open("/home/oem/my_web-site/orby_api/sunny/training_data", "rb"))
	words = data['words']
	classes = data['classes']
	train_x_y = [data['train_x'], data['train_y']]

	with open('/home/oem/my_web-site/orby_api/sunny/intents.json') as json_data:
	...
	model.load('/home/oem/my_web-site/orby_api/sunny/model.tflearn')
